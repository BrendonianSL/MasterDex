...
export function Header() {
    ...
    //Subscribes To Dark Mode So It Can Change State Whenever It Changes.
        ...
        <header>
            <nav>
                ...
                <div id={styles.headerLinks}>
                    <button className={styles.headerLink}><Link to="/pokedex">Pokedex</Link></button>
                    <button className={styles.headerLink}><Link to="/pokecompare">PokeCompare</Link></button>
                    <button className={styles.headerLink}><Link to="/pokeeval">PokeEval</Link></button>
                </div>
            </nav>
        </header>
    )
